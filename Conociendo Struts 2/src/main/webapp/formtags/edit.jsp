...
<title>Struts 2 Etiquetasa de Formulario - Editar Persona</title>
</head>
<body>
	...
	<s:form action="salvar" method="post">
		...
		<s:select key="personaBean.residencia" list="estados"
			listKey="abrevEstado" listValue="nombreEstado" />
		<s:checkbox key="personaBean.mayorde21" />
		<s:checkboxlist key="personaBean.modelosCoche"
			list="modelosCocheDisponibles" />
		<s:submit key="submit" />
	</s:form>
