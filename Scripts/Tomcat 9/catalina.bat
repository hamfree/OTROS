...
rem                   "dt_socket".
rem   JPDA_ADDRESS    (Opcional) Las opcionas de tiempo de ejecucion de Java
...
rem                   DEBEN ser especificadsa. Los valores por defecto son:
rem
...
rem 
rem   LOGGING_MANAGER (Opcional) Sobreescribe las trazas del gestor de Tomcat   
rem                   Ejemplo (todo en una linea)
